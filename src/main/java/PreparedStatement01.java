import java.sql.*; // * => SQL importlarının tamamını temsil eder.

public class PreparedStatement01 { // Hazırlanmıs Statement
    public static void main(String[] args) throws SQLException {
        ...
        //daha sonra soruda istenen degerleri degistirmek istersek hem IBM degeri hem de number_of_employees degerini dinamik olarak degistirebilmek
        // için ? kullandık.
        //2. Adım:PreparedStatement objesi oluştur
        PreparedStatement preparedStatement = connection.prepareStatement(sql1);

        //3. Adım: preparedStatement objesi ile setInt gibi methodlarla soru işaretleri yerlerine koymak istediğimiz değerleri yerleştiriyoruz.
        ...
        System.out.println("updateSayisi = " + updateSayisi); //1
